...
public:
    ...
    public:
        ...
        enum Status
        {
            ...
            ConnectionFailed = 1001, ///< Not part of the FTP standard, generated by SFML when the low-level m_socket connection with the server fails
            ConnectionClosed = 1002, ///< Not part of the FTP standard, generated by SFML when the low-level m_socket connection is unexpectedly closed
